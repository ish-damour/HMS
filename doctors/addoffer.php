    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <!-- <canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas> -->
              ...
              <div class="container col-md-7  shadow-sm border-bottom  text-secondary  pb-2 my-3 h5 text-center">
                Please fill this form to give appointment to patients
              </div>
              <div class="container col-md-7  shadow border   p-3 my-3">
                <form role="form" name="book" method="post" action="offeraddlogic.php" class="border-radius-6">
      <?php echo $message ?>
...
<div class="form-group">
        ...
        $sele1=mysqli_query($con,"SELECT * FROM doctors,doctor_specialization where doctor_specialization.Specialization_id=doctors.Specialization  and doctors.docemail='$loggedemail'");
      ...
      <?php
          ...
          ?>
          <option value=" ">no Specialization Available</option>
          <?php
        }
         ?>
         </select>
      ...
      <div class="form-group">
         ...
         <input type="text" disabled value="<?php echo $loggedname ?>" name="docname" placeholder="Enter Doctor Name" class="form-control my-2" required>
            </div>
      <div class="form-group">
<!--                  <label for="Doctor Specialization">
         Doctor Address
   ...
   <!--             <label for="Doctor Specialization">
        ...
        <!-- <option value=" -->
        <?php
         // echo $frow["province_id"] 
       ?>
       <!-- "> -->
       <?php 
       // echo $frow["province_name"]
        ?>
      <!-- </option> -->
      <?php
        // }
...
<!--      <div class="form-group">
      ...
      <div class="form-group mt-2 col-sm-6">
        <label for="fess">
          ...
          <?php 
          $sd=date("Y-m-d");
          $das=date("Y-m-d",strtotime($sd."+1 day"));
           ?>
        </label>
          <input type="date" name="startdate" min="<?php echo $das ?>"  class="form-control" required>
      </div>
      <div class="form-group mt-2 col-sm-6">
        <label for="fess">
          max number of patients needed 
        </label>
                    <input type="number" name="maxnumber" min="1" class="form-control"  placeholder="Enter maximum number of patients per Day" required="required">
      </div>
</div>
     <div class="row">
      <div class="form-group mt-2 col-sm-6">
      ...
      <div class="form-group mt-2 col-sm-6">
        <label for="fess">
          ...
          <input type="time"   name="endtime" class="form-control"  placeholder="Enter Doctor Email Address" required>
      </div>   
      </div>   
...
<!--         <label for="exampleInputPassword1">
          ...
          <input type="text" name="place" class="form-control" value="RULI DH" required>
      </div>
      <div class="btn-group col-sm-12 mt-3">
               <div class="col-sm-5 mx-4">
                <button type="submit" name="generate" class="btn btn-sm btn-outline-info rounded-0 form-control"><i class="fa fa-plus-circle"></i> Generate</button></div>
               <div class="col-sm-5 "> 
