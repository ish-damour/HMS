    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <!-- <canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas> -->
              ...
              <div class="container col-md-7  shadow-sm border-bottom  text-secondary  pb-2 my-3 h5 text-center">
                Please fill this form to add new doctor
              </div>
              <div class="container col-md-7  shadow border   p-3 my-3">
                <form role="form" name="book" method="post" action="doctoraddlogic.php" class="border-radius-6">
      <?php echo $message ?>
...
<!--                <label for="Doctor Specialization">
         ...
         <input type="text" name="docname" placeholder="Enter Doctor Name" class="form-control my-2" required>
            </div>
      <div class="form-group">
<!--                  <label for="Doctor Specialization">
         Doctor Address
...
<!--         <label for="fess">
          ...
          <input type="number" name="doccontact"  class="form-control"  placeholder="Enter Doctor Phone No 0780000000">
      </div>
      <div class="form-group mt-2">
<!--         <label for="fess">
          Doctor Email
