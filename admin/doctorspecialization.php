...
<?php include('../includes/connection.php') ?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2 class="text-center">List Of All Specialization</h2>
      <?php echo $message ?>
      <hr>
      <div class="table-responsive small">
          <?php
         $sel=mysqli_query($con,"SELECT * FROM doctor_specialization");
...
<tbody>
                <tr><form method="post" action="managedoctorlogic.php">
                  ...
                  <td>
<input type="text" name="Specializationname" value="<?php echo $fec["docspecialization"]?>" class="form-control">
                  </td>  
